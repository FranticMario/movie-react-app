...
const Favorites = () => {
    ...
    return (
      <section className="mx-auto p-6 min-h-screen flex justify-center items-center">
        <div className="text-center">
          ...
          <p className="mt-2">Add movies to your favorites to see them here.</p>
  ...
  return (
    <>
      <section className="w-full min-h-screen flex justify-center mb-32 mt-8">
        <div className="w-full">
          <h1 className="text-2xl text-center pt-4 font-bold mb-4">Your Favorite Movies</h1>
          <ul className="space-y-4">
            {favorites.map(movie => (
              <li key={movie.id} className="w-full flex justify-between items-center bg-white rounded-lg shadow-md p-5">
                {/* Link to Movie Page */}
                <Link
