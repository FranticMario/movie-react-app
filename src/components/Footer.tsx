...
const Footer = () => {
  return <>
    <footer className='my-12'>
      <nav className="flex justify-evenly">
        <NavLink to={'/'} className={({ isActive }) => isActive ? "text-red-500 flex items-center" : "text-gray-400 flex items-center"}>
          {({ isActive }) => (
            <>
        ...
        <NavLink to={'/favorites'} className={({ isActive }) => isActive ? "text-red-500 flex items-center" : "text-gray-400 flex items-center"}>
          {({ isActive }) => (
            <>
        ...
        <NavLink to={'/downloads'} className={({ isActive }) => isActive ? "text-red-500 flex items-center" : "text-gray-400 flex items-center"}>
          {({ isActive }) => (
            <>
        ...
        <NavLink to={'/profile'} className={({ isActive }) => isActive ? "text-red-500 flex items-center" : "text-gray-400 flex items-center"}>
          {({ isActive }) => (
            <>
